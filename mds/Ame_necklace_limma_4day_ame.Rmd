...
info_samples_SRP068487 <- info_samples_SRP068487[info_samples_SRP068487$ageName!="2day",]
...
write.table(diffMatches.caste,"/Users/afarre/Unimelb/Doublesex/Amellifera/dsCaste_4day_ame.txt", col.names = TRUE)
...
write.table(diffMatches.sex,"/Users/afarre/Unimelb/Doublesex/R/dsSex_4day_ame.txt", col.names = TRUE)

```

```{r}
fru <- diffMatches.sex[grep(ameMatches[grep(".*fruitless.*", ameMatches$geneName, ignore.case = TRUE),]$gene, diffMatches.sex$gene),]$ID
fru <- ex.sex$genes$GeneID[grep(fru, ex.sex$genes$GeneID)][1]
plotSplice(ex.sex, coef = 1, geneid = fru)
```
...
write.table(deMatches.caste,"/Users/afarre/Unimelb/Doublesex/Amellifera/deCaste_4day_ame.txt", col.names = TRUE)
...
write.table(deMatches.sex,"/Users/afarre/Unimelb/Doublesex/Amellifera/deSex_4day_ame.txt", col.names = TRUE)
