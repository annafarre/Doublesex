...
```{r rows.print=5}
sample_id_SRP046740<-read.table("/Users/afarre/Unimelb/Doublesex/Amellifera/data_info/Ame_SRP046740_SRR_Acc_List.txt", col.names = "sampleID", stringsAsFactors = F )
...
info_samples_SRP046740<-read.table("/Users/afarre/Unimelb/Doublesex/Amellifera/data_info/Ame_SRP046740_SraRunTable.txt", sep = "\t", header = T,  stringsAsFactors = F )
...
info_samples_SRP046740$casteName <- ""
info_samples_SRP046740[grep( "worker", info_samples_SRP046740$source_name_s, perl=T),]$casteName <- "Worker"
info_samples_SRP046740[grep( "queen", info_samples_SRP046740$source_name_s, perl=T),]$casteName <- "Queen"
info_samples_SRP046740[grep( "drone", info_samples_SRP046740$source_name_s, perl=T),]$casteName <- "Male"

info_samples_SRP046740$ageName <- "pre-pupa"

info_samples_SRP046740$sexName <- "sex"
info_samples_SRP046740[grep( "queen", info_samples_SRP046740$source_name_s, perl=T),]$sexName <- "Female"
info_samples_SRP046740[grep( "worker", info_samples_SRP046740$source_name_s, perl=T),]$sexName <- "Female"
info_samples_SRP046740[grep( "drone", info_samples_SRP046740$source_name_s, perl=T),]$sexName <- "Male"

info_samples_SRP046740$studyName <- "study"
info_samples_SRP046740[grep( "SRP046740", info_samples_SRP046740$SRA_Study_s, perl=T),]$studyName <- "SRP046740"
...
info_samples_SRP046740$caste <- ""
info_samples_SRP046740[grep( "worker", info_samples_SRP046740$source_name_s, perl=T),]$caste <- "2"
info_samples_SRP046740[grep( "queen", info_samples_SRP046740$source_name_s, perl=T),]$caste <- "1"
info_samples_SRP046740[grep( "drone", info_samples_SRP046740$source_name_s, perl=T),]$caste <- "3"

info_samples_SRP046740$age <- "3"

info_samples_SRP046740$sex <- "sex"
info_samples_SRP046740[grep( "queen", info_samples_SRP046740$source_name_s, perl=T),]$sex <- "1"
info_samples_SRP046740[grep( "worker", info_samples_SRP046740$source_name_s, perl=T),]$sex <- "1"
info_samples_SRP046740[grep( "drone", info_samples_SRP046740$source_name_s, perl=T),]$sex <- "2"

info_samples_SRP046740$study <- "study"
info_samples_SRP046740[grep( "SRP046740", info_samples_SRP046740$SRA_Study_s, perl=T),]$study <- "2"

sample_table_SRP046740 <- dplyr::select(info_samples_SRP046740, age, Run_s, caste, sex, study, ageName, casteName, sexName, studyName)
# sample_table_SRP068487 <- dplyr::select(info_samples_SRP068487, age, Run_s, caste, sex, study, ageName, casteName, sexName, studyName)

# data_info <- rbind(sample_table_SRP046740, sample_table_SRP068487)
data_info <- sample_table_SRP046740
...
write.table(diffMatches.caste,"/Users/afarre/Unimelb/Doublesex/R/dsCaste_prepupa_ame.txt", col.names = TRUE)
...
Subset data for SRP046740
```{r  rows.print=5}
counts <- read.csv("/Users/afarre/Unimelb/Doublesex/Amellifera/necklace/gene.counts", sep = "\t", skip = 1, stringsAsFactors = F)
names(counts) <- gsub(".*(SRR.*)\\.bam","\\1", names(counts))
...
write.table(deMatches.caste,"/Users/afarre/Unimelb/Doublesex/R/deCaste_prepupa_ame.txt", col.names = TRUE)
...
write.table(deMatches.sex,"/Users/afarre/Unimelb/Doublesex/R/deSex_prepupa_ame.txt", col.names = TRUE)
```
