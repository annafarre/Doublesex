...
# 
# info_samples_SRP068487$age <- "age"
# info_samples_SRP068487[grep( "4-day old", info_samples_SRP068487$Sample_Name_s, perl=T),]$age <- "1"
# info_samples_SRP068487[grep( "2-day old", info_samples_SRP068487$Sample_Name_s, perl=T),]$age <- "2"
# 
...
# dge$samples$age <- ""
# dge$samples[as.data.frame(design)$fourDay==1,]$age <- "1"
# dge$samples[as.data.frame(design)$prepupa==1,]$age <- "3"
# dge$samples[as.data.frame(design)$fourDay==0&as.data.frame(design)$prepupa==0,]$age <- "2"
...
# dge$samples$study <- ""
# dge$samples[as.data.frame(design)$SRP046740==1,]$study <- "2"
# dge$samples[as.data.frame(design)$SRP046740==0,]$study <- "1"
...
write.table(x = as.data.frame(unlist(Ame_diffMatches.sex)), file = "../../R/Ame_diffMatches_sex.txt", col.names = TRUE, row.names = TRUE)
write.table(x = as.data.frame(unlist(Ame_diffMatches.caste)), file = "../../R/Ame_diffMatches_caste.txt", col.names = TRUE, row.names = TRUE)

# length(intersect(Ame_intersect_diffMatches, Aec_intersect_diffMatches, Wau_intersect_diffMatches))

# length(intersect(intersect(Ame_intersect_diffMatches, Wau_intersect_diffMatches), Aec_intersect_diffMatches))
```
...
# dcaste <- sapply(unlist(strsplit(a$GeneID, ":"))[grep("gene*", unlist(strsplit(a$GeneID, ":")))], function(e){ame_gtf[mcols(ame_gtf)$ID==e]$Name})
# 
# nay <- na.omit(as.data.table(ame_gtf), cols="gene")
...
# 
# write.table(x = int_genes, file = "/Users/afarre/Unimelb/Doublesex/R/Ame_prepupa_AS_int_genes.txt", col.names = TRUE, row.names = TRUE)
# int_genes
```
...
# plotPCA(v$E, groups=v$targets$caste)
```
