...
matches.summary.caste <- data.frame(Diff_spliced_genes=c(noMatch.caste, oneMatch.caste, multipleMatch.caste), match=factor(c("0", "1", ">2"), levels =c("0", "1", ">2")))

ggplot(matches.summary.caste, aes(match, Diff_spliced_genes))+
  geom_bar(stat="identity")
...
# 
# write.table(x = int_genes, file = "/Users/afarre/Unimelb/Doublesex/R/Ame_4days_AS_int_genes.txt", col.names = TRUE, row.names = TRUE)
# int_genes
```
