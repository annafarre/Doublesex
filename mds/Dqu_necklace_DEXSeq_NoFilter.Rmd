...
#Differential Splicing: Analysis of necklace output of _Dinoponera quadriceps_ 
##Pre-processing
...
pdf("/Users/afarre/Unimelb/Doublesex/R/DEXSeq/Dqu_dispersionEstimates.pdf")
plotDispEsts(dxd)
dev.off()
...
```{r}
save(dxd, res, pgq, file = "/Users/afarre/Unimelb/Doublesex/R/DEXSeq/Dqu_DEXseq_NoFilter.Rdata")
write.table(tmp, file = "/Users/afarre/Unimelb/Doublesex/R/DEXSeq/Dqu_DEXseq_byGene_NoFilter.txt", col.names = TRUE, row.names = FALSE, quote = FALSE, sep = "\t")
write.table(DEXSeqResults(dxd), file="/Users/afarre/Unimelb/Doublesex/R/DEXSeq/Dqu_DEXseq_byExon_NoFilter.txt", col.names = TRUE, row.names = FALSE, quote = FALSE, sep = "\t" )
```
