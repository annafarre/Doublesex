...
write.table(diffMatches.caste,"/Users/afarre/Unimelb/Doublesex/Amellifera/dsCaste_2day_ame.txt", col.names = TRUE)
...
write.table(diffMatches.sex,"/Users/afarre/Unimelb/Doublesex/R/dsSex_2day_ame.txt", col.names = TRUE)
```
...
venn.plot <- draw.pairwise.venn(area1 = length(ds_matchedgenes[ds_matchedgenes$contrast=="sex",]$gene), 
                   ...
                   category = c("DS sex", "DS caste"), print.mode = c("raw", "percent"))
...
write.table(deMatches.caste,"/Users/afarre/Unimelb/Doublesex/R/deCaste_2day_ame.txt", col.names = TRUE)
...
# write.table(deMatches.sex,"/Users/afarre/Unimelb/Doublesex/Amellifera/deSex_2day_ame.txt", col.names = TRUE)
