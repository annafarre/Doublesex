...
/home/afarre/.local/TrimGalore-0.4.5/trim_galore --fastqc --gzip --output_dir ${outputPath} --paired ${inputPath}${filename}_pass_1.fastq.gz ${inputPath}${filename}_pass_2.fastq.gz
EOF
done <"${list}"