...
#to index bam files 
library(Rsamtools)
indexBam("fru2ST_workersDPR02877.bam")
indexBam("fru2ST_workersOther.bam")
indexBam("fru2ST.bam")
indexBam("fru2ST_queensDRP002877.bam")


alTrackW <- AlignmentsTrack("fru2ST_workersDPR02877.bam",type = c("coverage"),name="Workers DPR02877",
                            background.title ="#042E8A",col="#042E8A",fill="#042E8A", size=2)
alTrackW2 <- AlignmentsTrack("fru2ST_workersOther.bam",type = c("coverage"),name="Workers Other",
                            background.title ="#042E8A",col="#042E8A",fill="#042E8A", size=2)
alTrackQ <- AlignmentsTrack("fru2ST_queensDRP002877.bam",type = c("coverage"),name="Queens DPR02877",
                            background.title ="#042E8A",col="#042E8A",fill="#042E8A", size=2)


#add in the transcripts
library(rtracklayer)
transGranges<-as(import.gff3("Mph_fru_exons.gff"), "GRanges")
...
pdf(file="Mph_fru_sashimiQW.pdf")
