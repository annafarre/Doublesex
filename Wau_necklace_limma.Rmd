...
diff.caste <- topSplice(ex.caste.loess, coef=1, test="simes", number=numDiff.caste )
...
numDiff.sex <- 2000
diff.sex <- topSplice(ex.sex, coef=1, test="simes", number= numDiff.sex )
